...
impl Blob {
    ...
    pub fn random_point(&self) -> Fp {
        ...
        Fp::from_raw(U256::from(keccak256(input)).0)
    }
...
pub struct BlobAssignments {
    pub z: Fp,
    pub y: Fp,
    pub coefficients: [Fp; BLOB_WIDTH],
}
